...
import { getCachedImage, setCachedImage, CachedImage } from '@/lib/services/image-cache';
import { searchProductImage, validateAndExtractImage } from '@/lib/services/image-search';
